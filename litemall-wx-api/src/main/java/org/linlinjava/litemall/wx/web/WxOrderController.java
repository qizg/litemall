...
public class WxOrderController {
    ...
    public Object balancePay(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        return wxOrderService.balancePay(userId, body, request);
    }
